...
# For a healthy, athletic person, 60 is resting, 180 is intensive exercising
bpm = 60
bps = bpm / 60
...
# bit resolution is
# note: check if this is correct: not sure if there should be
# negative bit values.
...
pylab.title('%d bpm ECG signal with gaussian noise sampled at %d Hz'
            % (bpm, sampling_rate))
pylab.show()
